...
public final class AsyncTestHelpers {
    ...
    public static func measureAsync<T: Sendable>(
        operation: @escaping @Sendable () async throws -> T
    ...
    public static func expectTimingWithin<T: Sendable>(
    ...
    public static func executeSequentially<T: Sendable>(
        operations: [(id: String, operation: @Sendable () async throws -> T)],
    ...
    public static func testCancellation<T: Sendable>(
        operation: @escaping @Sendable () async throws -> T,
    ...
    public static func testGroupCancellation<T: Sendable>(
        groupOperation: @escaping @Sendable () async throws -> T
    ) async -> Bool {
        let task = Task {
    ...
    public static func testActorIsolation<A: Actor, T: Sendable>(
        actor: A,
        accessOperations: [@Sendable (A) async throws -> T]
    ) async -> Bool {
        do {
    ...
    public static func expectAsyncThrows<E: Error, T: Sendable>(
    ...
    public static func expectAsyncNoThrow<T: Sendable>(
        operation: @escaping @Sendable () async throws -> T
    ) async throws -> T {
        do {
    ...
    public static func expectAsyncEqual<T: Equatable & Sendable>(
        _ expected: T,
        operation: @escaping @Sendable () async throws -> T
    ) async throws {
        let result = try await operation()
    ...
    public static func waitForAllConditions(
        conditions: [@Sendable () async -> Bool],
        timeout: TimeInterval = defaultTimeout
    ) async throws {
    ...
    public static func benchmark<T: Sendable>(
        iterations: Int,
        operation: @escaping @Sendable () async throws -> T
    ...
    public static func delayedResult<T: Sendable>(
        delay: TimeInterval,
        result: T
    ...
    public static func delayedError<T: Sendable>(
        delay: TimeInterval,
        error: Error
    ) -> @Sendable () async throws -> T {
        return {
    ...
    public static func randomOutcome<T: Sendable>(
...
public extension AsyncTestHelpers {
    ...
    static func requireAsyncThrows<E: Error & Equatable, T: Sendable>(
        _ expectedError: E,
        operation: @escaping @Sendable () async throws -> T
    ) async throws {
        do {
